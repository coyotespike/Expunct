...
(defn privacy-modal []
  [:div
   ...
   [:p "Protecting your private information is our priority. This Statement of Privacy applies to the www.expunct.com and Expunct and governs data collection and usage. For the purposes of this Privacy Policy, unless otherwise noted, all references to Expunct include www.expunct.com and Expunct. The Expunct website is a expunction helper site. By using the Expunct website, you consent to the data practices described in this statement."]
   [:p "Collection of your Personal Information"]
   [:p "Expunct may collect personally identifiable information, such as your name. Expunct may also collect anonymous demographic information, which is not unique to you, such as your age, gender, household income and race. We may gather additional personal or non-personal information in the future."]

   [:p "Information about your computer hardware and software may be automatically collected by Expunct. This information can include: your IP address, browser type, domain names, access times and referring website addresses. This information is used for the operation of the service, to maintain quality of the service, and to provide general statistics regarding use of the Expunct website."]

   [:p "Expunct encourages you to review the privacy statements of websites you choose to link to from Expunct so that you can understand how those websites collect, use and share your information. Expunct is not responsible for the privacy statements or other content on websites outside of the Expunct website."]

   [:p "Use of your Personal Information"]
   [:p "Expunct collects and uses your personal information to operate its website(s) and deliver the services you have requested."]

   [:p "Expunct may also use your personally identifiable information to inform you of other products or services available from Expunct and its affiliates. Expunct may also contact you via surveys to conduct research about your opinion of current services or of potential new services that may be offered."]

   [:p "Expunct does not sell, rent or lease its customer lists to third parties."]

   [:p "Expunct may share data with trusted partners to help perform statistical analysis, send you email or postal mail, provide customer support, or arrange for deliveries. All such third parties are prohibited from using your personal information except to provide these services to Expunct, and they are required to maintain the confidentiality of your information."]

   [:p "Expunct may keep track of the websites and pages our users visit within Expunct, in order to determine what Expunct services are the most popular. This data is used to deliver customized content and advertising within Expunct to customers whose behavior indicates that they are interested in a particular subject area."]

   [:p "Expunct will disclose your personal information, without notice, only if required to do so by law or in the good faith belief that such action is necessary to: (a) conform to the edicts of the law or comply with legal process served on Expunct or the site; (b) protect and defend the rights or property of Expunct; and, (c) act under exigent circumstances to protect the personal safety of users of Expunct, or the public."]

   [:p "Use of Cookies"]
   [:p "The Expunct website may use 'cookies' to help you personalize your online experience. A cookie is a text file that is placed on your hard disk by a web page server. Cookies cannot be used to run programs or deliver viruses to your computer. Cookies are uniquely assigned to you, and can only be read by a web server in the domain that issued the cookie to you."]

[:p "One of the primary purposes of cookies is to provide a convenience feature to save you time. The purpose of a cookie is to tell the Web server that you have returned to a specific page. For example, if you personalize Expunct pages, or register with Expunct site or services, a cookie helps Expunct to recall your specific information on subsequent visits. This simplifies the process of recording your personal information, such as billing addresses, shipping addresses, and so on. When you return to the same Expunct website, the information you previously provided can be retrieved, so you can easily use the Expunct features that you customized."]

   [:p "You have the ability to accept or decline cookies. Most Web browsers automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. If you choose to decline cookies, you may not be able to fully experience the interactive features of the Expunct services or websites you visit."]

   [:p "Security of your Personal Information"]
   ...
   [:p "Verisign is an independent, third-party company engaged in the development of digital trust. Verisign provides authentication of Internet services, digital identity and intellectual property. By clicking on the Verisign logo, the Verisign website will serve up a web page that confirms that Expunct is 'Verisign Authenticated."]

   [:p "Children Under Thirteen"]
   [:p "Expunct does not knowingly collect personally identifiable information from children under the age of thirteen. If you are under the age of thirteen, you must ask your parent or guardian for permission to use this website."]

   [:p "Opt-Out & Unsubscribe"]
   [:p "We respect your privacy and give you an opportunity to opt-out of receiving announcements of certain information. Users may opt-out of receiving any or all communications from Expunct by contacting us at admin@expunct.com."]

   [:p "Changes to this Statement"]
   [:p "Expunct will occasionally update this Statement of Privacy to reflect company and customer feedback. Expunct encourages you to periodically review this Statement to be informed of how Expunct is protecting your information."]

   [:p "Contact Information"]
   [:p "Expunct welcomes your questions or comments regarding this Statement of Privacy. If you believe that Expunct has not adhered to this Statement, please contact Expunct at:"]

   [:p "Email Address:"]
   [:p "admin@expunct.com"]

   [:p "Effective as of October 09, 2015"]])
...
(defn tc-modal []
  [:div
   [:p "TERMS OF SERVICE"]
   [:p "The website and Expunct's services are not substitutes for the advice of an attorney, and no attorney-client relationship is or can be formed through your usage of this site and Expunct's services."]
   [:p "----"]

   [:p "OVERVIEW"]

   [:p "This website is operated by Expunct. Throughout the site, the terms “we”, “us” and “our” refer to Expunct. Expunct offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here."]
   ...
   [:p "Nothing on this site constitutes legal advice. Expunct is not your attorney, and you should seek the advice of an attorney to advise you about your rights and responsibilities under the law. "]
...
[:p "In no case shall Expunct, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
"]


   [:p "SECTION 14 - INDEMNIFICATION"]

   [:p "You agree to indemnify, defend and hold harmless Expunct and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party."]
   ...
   [:p "These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of Texas, USA."]
   ...
   [:p "Questions about the Terms of Service should be sent to us at admin@expunct.com."]])
         ...
         [:form {:role "form"}
          ...
          [:div.row
           [:div {:class "col-xs-12 col-sm-6 col-md-pull-6"}
            [:div.form-group
             [medium-text-box :first-name :enter-first-name]]]
